...
const AuthForm = ({ mode, onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      {mode === 'signup' && <input type="text" name="nickname" value={formData.nickname} onChange={handleChange} placeholder="닉네임" required className="w-full p-4 border border-gray-300 rounded-lg" />}
